...
const projects = [
  {
    ...
    href: "/projects/aura-digital-cathedral", tag: "PROJECTION MAPPING", filterCategory: "museums",
  },
  {
    ...
    href: "/projects/skyline-observation-floor", tag: "INTERACTIVE FLOOR", filterCategory: "public-spaces",
  },
  {
    ...
    href: "/projects/biosphere-ocean-experience", tag: "INTERACTIVE FLOOR", filterCategory: "museums",
  },
  {
    ...
    href: "/projects/interactive-museum-exhibit", tag: "INTERACTIVE WALL & FLOOR", filterCategory: "museums",
  },
  {
    ...
    href: "/projects/corporate-lobby-installation", tag: "PROJECTION MAPPING", filterCategory: "corporate",
  },
  {
    ...
    href: "/projects/pediatric-hospital-floor", tag: "INTERACTIVE FLOOR", filterCategory: "healthcare",
  },
  {
    ...
    href: "/projects/flagship-store-activation", tag: "MOTION SENSORS", filterCategory: "retail",
  },
  {
    ...
    href: "/projects/immersive-stem-lab", tag: "INTERACTIVE WALL", filterCategory: "education",
  },
  {
    ...
    href: "/projects/neo-tokyo-retail-popup", tag: "TOUCH & GESTURE", filterCategory: "retail",
  },
  {
    ...
    href: "/projects/ai-receptionist-avatar", tag: "AI AVATARS", filterCategory: "corporate",
  },
  {
    ...
    href: "/projects/sensory-therapy-room", tag: "PROJECTION MAPPING", filterCategory: "healthcare",
  },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse 65% 55% at 50% 50%, rgba(255,255,255,0.05), transparent 70%)" }}
      />
      ...
      <motion.div
        ...
        className="relative w-full max-w-5xl h-full max-h-[88vh] rounded-[2rem] overflow-hidden cursor-default shadow-2xl border border-white/15 bg-black pointer-events-auto z-10 flex flex-col justify-end"
      >
        ...
        <motion.div
          className="absolute left-0 right-0 h-px z-20 pointer-events-none opacity-40"
          style={{ background: "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.5), transparent 100%)" }}
          animate={{ top: ["5%", "95%", "5%"] }}
          transition={{ duration: 5, repeat: Infinity, ease: "linear" }}
        />

        <div className="relative z-30 p-6 sm:p-8 lg:p-12 w-full max-w-4xl" style={{ transform: "translateZ(30px)" }}>
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 text-[11px] sm:text-xs font-mono uppercase tracking-wider text-white/90 mb-3 sm:mb-4">
          ...
          <h3 className="text-white leading-[1.08] mb-3 sm:mb-4 drop-shadow-lg text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black tracking-tight">
            {project.title}
          </h3>

          <p className="text-xs sm:text-sm lg:text-base text-white/75 font-light leading-relaxed max-w-2xl mb-6 sm:mb-8 line-clamp-3">
            {project.desc}
          </p>
          ...
          <div className="flex items-center gap-4 flex-wrap relative z-50 pointer-events-auto">
            <Link 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-3.5 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider text-black bg-white transition-all hover:scale-105 active:scale-95 shadow-xl cursor-pointer pointer-events-auto"
            >
...
function ProjectCard({
  ...
  return (
    <motion.div
      layout
      animate={{
        scale: isDesktop ? (isActive ? 1.04 : 0.92) : 1,
        opacity: isDesktop ? (isActive ? 1 : 0.7) : 1,
      }}
      transition={{ type: "spring", stiffness: 280, damping: 26 }}
      className="group relative w-full sm:w-[48vw] md:w-[36vw] lg:w-[28vw] 2xl:w-[22vw] 3xl:w-[18vw] h-[45vh] sm:h-[50vh] lg:h-[42vh] xl:h-[46vh] min-h-[300px] max-h-[460px] 2xl:max-h-[520px] rounded-3xl overflow-hidden bg-black lg:flex-shrink-0 cursor-pointer shadow-2xl"
      onClick={onClick}
      style={{
        boxShadow: (isDesktop ? isActive : true)
          ? "0 30px 80px -15px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.3)"
    ...
    >
      ...
      {isActive && (
        <motion.div
          ...
          style={{ boxShadow: "inset 0 0 0 2px rgba(255,255,255,0.8), 0 0 40px -10px rgba(255,255,255,0.2)" }}
        />
      )}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 z-10 space-y-2">
        <div className="flex items-center justify-between gap-2 text-[10px] sm:text-[11px] font-mono uppercase tracking-wider text-white/70">
          ...
          <span className="text-white/40 tracking-wider">
            PROJECT {String(idx + 1).padStart(2, "0")} OF {String(totalCount).padStart(2, "0")}
          </span>
        </div>
        <h3 className="text-white text-lg font-bold">{project.title}</h3>
        <p className="text-xs text-white/70 font-light leading-relaxed line-clamp-2">{project.desc}</p>
        <div className="pt-2 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-white/80 group-hover:text-white transition-colors">
      ...
      <section ref={targetRef} className="relative lg:h-[450vh] bg-gray-50 text-black py-10 lg:py-0">
        <div className="lg:sticky lg:top-0 flex flex-col lg:flex-row lg:h-[100dvh] items-center lg:overflow-hidden">
          <div className="w-full flex flex-col justify-between h-full py-4 sm:py-6 lg:py-6">
            ...
            <div className="hidden lg:block max-w-7xl 2xl:max-w-[1536px] 3xl:max-w-[1720px] w-full mx-auto px-4 sm:px-6 lg:px-8 z-20">
