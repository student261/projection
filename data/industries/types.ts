...
export interface IndustryExperience { title: string; desc: string; tags: string[]; img: string; }
...
export interface IndustryData {
  ...
  vision: { title: string; intro: string; statement: string; pillars: IndustryVisionPillar[]; transition: string; quote: string; };
