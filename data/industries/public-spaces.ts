...
export const publicSpaces: IndustryData = {
  ...
  icon: Compass,
  hero: {
    eyebrow: "PUBLIC SPACES & TRANSIT",
    title: "Engage Thousands in High-Traffic Environments",
    subtitle: "Turn airports, public plazas, and transit hubs into captivating, interactive visual landmarks.",
  ...
  experiences: {
    ...
    items: [
      { title: "The Interactive Airport Terminal", desc: "A 200-foot interactive floor projection that acts as a digital playground for children waiting for flights.", tags: ["Interactive Floor", "Airport Tech"], img: "https://momentfactory.com/cdn/shop/files/Moment_Factory_Public_Spaces_Moynihan_Train_Hall_IMG_0693-WS.jpg" },
      { title: "Smart City Wayfinding", desc: "A transit hub floor that projects personalized, color-coded arrows to guide passengers to their connecting trains.", tags: ["Dynamic Wayfinding", "API Integration"], img: "https://momentfactory.com/cdn/shop/files/BLA_20130622_037-Edit_329555c5-3e3d-49fe-b032-345a547b652b.jpg" },
      { title: "The Digital Subway Tunnel", desc: "An immersive projection mapped pedestrian tunnel that changes themes based on the season or local events.", tags: ["Projection Mapping", "Public Art"], img: "https://momentfactory.com/cdn/shop/files/Moment_Factory_Public_Spaces_Shinjuku_Station_IMG_0457-Modifier-WS.jpg" },
      { title: "Civic Plaza Monument Mapping", desc: "Permanent architectural projection mapping on a city hall facade, used for nightly civic storytelling.", tags: ["Outdoor Projection", "Event Tech"], img: "https://momentfactory.com/cdn/shop/files/Moment-Factory-Changi_Airports_Terminal_4_Theatre_of_experience-7-WS.jpg" },
      { title: "Interactive Mall Atrium", desc: "A massive multi-story digital waterfall in a shopping center that parts when visitors walk near the base.", tags: ["Large Scale LED", "Motion Tracking"], img: "https://momentfactory.com/cdn/shop/files/Moment_Factory_Public_Spaces_Moynihan_Train_Hall_IMG_0693-WS.jpg" },
      { title: "Sponsored Holographic Zone", desc: "A leased public space where brands deploy interactive 3D campaigns to engage passing crowds without physical builds.", tags: ["DOOH Advertising", "Brand Activation"], img: "https://momentfactory.com/cdn/shop/files/BLA_20130622_037-Edit_329555c5-3e3d-49fe-b032-345a547b652b.jpg" }
    ]
  },
  benefits: {
